...
class ShowUssdDetailsPage extends StatefulWidget {
  final UssdCodeModel model;
  final Color primaryColor;
  final String lang;

  ShowUssdDetailsPage({Key key, this.lang, this.model, this.primaryColor})
      : super(key: key);

  @override
  _ShowUssdDetailsPageState createState() => _ShowUssdDetailsPageState();
}

class _ShowUssdDetailsPageState extends State<ShowUssdDetailsPage> {
  @override
