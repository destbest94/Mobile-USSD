...
class ShowMessageDetailsPage extends StatefulWidget {
  final MessagePackageModel model;
  final Color primaryColor;
  final String lang;

  ShowMessageDetailsPage({Key key, this.lang, this.model, this.primaryColor})
      : super(key: key);

  @override
  _ShowMessageDetailsPageState createState() => _ShowMessageDetailsPageState();
}

class _ShowMessageDetailsPageState extends State<ShowMessageDetailsPage> {
  @override
