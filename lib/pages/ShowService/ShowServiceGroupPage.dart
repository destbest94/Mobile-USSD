...
import 'package:mobile_ussd/pages/ShowService/components/serviceGroups.dart';

class ShowServiceGroupPage extends StatefulWidget {
  final dynamic model;
  final String title;
  ...
  @override
  _ShowServiceGroupPageState createState() => _ShowServiceGroupPageState();
}

class _ShowServiceGroupPageState extends State<ShowServiceGroupPage> {
  List tabs() {
    List<Widget> list = [];
