...
class ShowServiceDetailsPage extends StatefulWidget {
  final ServicesModel model;
  final Color primaryColor;
  final String lang;

  ShowServiceDetailsPage({Key key, this.lang, this.model, this.primaryColor})
      : super(key: key);

  @override
  _ShowServiceDetailsPageState createState() => _ShowServiceDetailsPageState();
}

class _ShowServiceDetailsPageState extends State<ShowServiceDetailsPage> {
  @override
