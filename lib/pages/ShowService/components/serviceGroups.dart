...
import 'package:mobile_ussd/pages/ShowService/components/ShowMinuteDetailsPage.dart';
import 'package:url_launcher/url_launcher.dart';

class ServicePackageList extends StatefulWidget {
  final List<ServicesModel> packageModels;
  final String lang;
  final int groupId;
  ...
  Widget build(BuildContext context) {
    List<Widget> tariffPlanItems() {
      ...
      for (var p in widget.packageModels) {
        if (p.servicesGroup == widget.groupId) {
          list.add(Stack(
