...
import 'package:mobile_ussd/pages/ShowMinute/components/minuteGroups.dart';

class ShowMinuteGroupPage extends StatefulWidget {
  final dynamic model;
  final String title;
  ...
  @override
  _ShowMinuteGroupPageState createState() => _ShowMinuteGroupPageState();
}

class _ShowMinuteGroupPageState extends State<ShowMinuteGroupPage> {
  List tabs() {
    List<Widget> list = [];
