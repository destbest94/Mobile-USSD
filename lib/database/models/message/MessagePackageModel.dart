class MessagePackageModel {
  ...
  final int messagePackagesGroup;
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'message_packages_group': messagePackagesGroup,
    };
  }

  factory MessagePackageModel.fromJson(Map<String, dynamic> json) {
    return MessagePackageModel(
      id: json['id'],
      ...
      messagePackagesGroup: json['message_packages_group'],
    );
  }
}
